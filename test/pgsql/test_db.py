...
class TestDB(unittest.TestCase):
    ...
    def test_schema(self):
        ...
        with testing.postgresql.Postgresql() as testpg:
            ...
            db.query('CREATE TABLE {} (id TEXT, a DOUBLE PRECISION, b DOUBLE PRECISION, c DOUBLE PRECISION, PRIMARY KEY (id))'.format(
    ...
    def test_protectMod(self):
        ...
        inpExpPairs = [
            ...
            ['select %(:x)s as b', 'select %(:x)s as b'],
            ['WHERE "matchId" IN (%(:0_1_e49e0bb1)s))',
             'WHERE "matchId" IN (%(:0_1_e49e0bb1)s))'],
            ['IN (%(:0_7_ce43ac50_178d_4d6f_9d95_f13a17f40446)s)',
             'IN (%(:0_7_ce43ac50_178d_4d6f_9d95_f13a17f40446)s)'],
            ['IN (%(:0_13_ce43ac50_178d_4d6f_9d95_f13a17f40446)s,',
             'IN (%(:0_13_ce43ac50_178d_4d6f_9d95_f13a17f40446)s,',]
        ]
    ...
    def test_schema_queries(self):
        with testing.postgresql.Postgresql() as testpg:
            ...
            self.assertIn(
                {'schema': 'u', 'table': 'user', 'path': 'u.user'}, rows)
            ...
            rows = db.query(db.columnQuery(
                pathRE='^u[.].*$|^b[.].*$'), fetchAll=True)
            ...
            rows = db.queryIndexes(
                pathRE='^u[.]user[.]user_pkey$', fetchAll=True)
